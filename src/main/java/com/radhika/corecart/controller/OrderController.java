...
import com.radhika.corecart.service.order.IOrderService;
...
public ResponseEntity<ApiResponse> createOrder(@RequestParam  Long userId){
    try {
       ...
       return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new ApiResponse("Error Creating Order",e.getMessage()));
    }
}
